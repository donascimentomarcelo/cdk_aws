...
public class Service01Stack extends Stack {
    public Service01Stack(final Construct scope, final String id, final Cluster cluster, final SnsTopic productEventTopic) {
        this(scope, id, null, cluster, productEventTopic);
    }

    public Service01Stack(final Construct scope, final String id, final StackProps props, final Cluster cluster, final SnsTopic productEventTopic) {
        ...
        ApplicationLoadBalancedFargateService service01 = ApplicationLoadBalancedFargateService.Builder.create(this, "ALB01")
                    ...
                    .taskImageOptions(
                            ApplicationLoadBalancedTaskImageOptions
                                ...
                                .image(ContainerImage.fromRegistry("donascimentomarcelo/awsproject:1.4.0"))
                                .containerPort(8080)
