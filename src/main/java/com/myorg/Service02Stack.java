...
public class Service02Stack extends Stack {
    public Service02Stack(final Construct scope, final String id, final Cluster cluster, final SnsTopic productEventsTopic) {
        ...
        ApplicationLoadBalancedFargateService service02 = ApplicationLoadBalancedFargateService.Builder.create(this, "ALB01")
                    ...
                    .taskImageOptions(
                            ApplicationLoadBalancedTaskImageOptions
                                ...
                                .image(ContainerImage.fromRegistry("donascimentomarcelo/consumer:1.0.0"))
                                .containerPort(8081)
